...
function Card() {
  ...
  const [ans1, setAns1] = useState((0.0).toFixed(2));
  const [ans2, setAns2] = useState((0.0).toFixed(2));
  const [tip, setTip] = useState(0);

  function handleSubmit() {
    setAns1(((bill * tip) / (100 * persons)).toFixed(2));
    setAns2((bill / persons).toFixed(2));
  }
  ...
  return (
    <div className="card">
      <div className="whiteCard">
        ...
        <input class="typeone" type="text" placeholder="0" onChange={HandleBillChange} />
        <svg
          className="dollarimg"
        ...
        <div className="Stip">Select Tip %</div>
        ...
        <div className="TipOptions">
          ...
          <div className="secondrow">
            ...
            <button className="tip" type="button">Custom</button>
          </div>
        </div>

        <div className="noofPeople">Number of People</div>
        <input className="typeone" type="text" placeholder="0" onChange={HandlePersonChange} />
        <svg
          className="personimg"
          xmlns="http://www.w3.org/2000/svg"
          width="13"
      ...
      <div className="greenCard">
        <div className="amountperperson">
          ...
          <div className="amountpp">${ans1}</div>
        </div>
        <div className="amountperperson">
          <div className="tiptotal">
          ...
          <div className="amountppp">${ans2}</div>
        </div>

        <button onClick={handleSubmit} className="Reset">
          SUBMIT
        </button>
